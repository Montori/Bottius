...
export class leaveMessage1591191626936 implements MigrationInterface {
    name = 'leaveMessage1591191626936'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_partition" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "guildID" varchar NOT NULL, "suggestChannel" varchar, "leaveChannel" varchar, "leaveMessage" varchar)`);
        await queryRunner.query(`INSERT INTO "temporary_partition"("id", "guildID", "suggestChannel", "leaveChannel") SELECT "id", "guildID", "suggestChannel", "leaveChannel" FROM "partition"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "partition" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "guildID" varchar NOT NULL, "suggestChannel" varchar, "leaveChannel" varchar)`);
        await queryRunner.query(`INSERT INTO "partition"("id", "guildID", "suggestChannel", "leaveChannel") SELECT "id", "guildID", "suggestChannel", "leaveChannel" FROM "temporary_partition"`);
