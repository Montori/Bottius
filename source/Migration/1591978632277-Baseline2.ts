...
export class Baseline21591978632277 implements MigrationInterface {
    name = 'Baseline21591978632277'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "bug" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" datetime NOT NULL, "description" varchar NOT NULL, "assignorId" integer)`, undefined);
        await queryRunner.query(`CREATE TABLE "lyrics" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "songtext" varchar NOT NULL, "artist" varchar NOT NULL, "partitionId" integer)`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_bug" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" datetime NOT NULL, "description" varchar NOT NULL, "assignorId" integer, CONSTRAINT "FK_c2661dfa88c944e994e0bed7930" FOREIGN KEY ("assignorId") REFERENCES "user" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`, undefined);
        await queryRunner.query(`INSERT INTO "temporary_bug"("id", "createdAt", "description", "assignorId") SELECT "id", "createdAt", "description", "assignorId" FROM "bug"`, undefined);
        await queryRunner.query(`DROP TABLE "bug"`, undefined);
        await queryRunner.query(`ALTER TABLE "temporary_bug" RENAME TO "bug"`, undefined);
        await queryRunner.query(`CREATE TABLE "temporary_lyrics" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "songtext" varchar NOT NULL, "artist" varchar NOT NULL, "partitionId" integer, CONSTRAINT "FK_c3bc88d35bb9001ad2e8a94ec45" FOREIGN KEY ("partitionId") REFERENCES "partition" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`, undefined);
        await queryRunner.query(`INSERT INTO "temporary_lyrics"("id", "songtext", "artist", "partitionId") SELECT "id", "songtext", "artist", "partitionId" FROM "lyrics"`, undefined);
        await queryRunner.query(`DROP TABLE "lyrics"`, undefined);
        await queryRunner.query(`ALTER TABLE "temporary_lyrics" RENAME TO "lyrics"`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "lyrics" RENAME TO "temporary_lyrics"`, undefined);
        await queryRunner.query(`CREATE TABLE "lyrics" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "songtext" varchar NOT NULL, "artist" varchar NOT NULL, "partitionId" integer)`, undefined);
        await queryRunner.query(`INSERT INTO "lyrics"("id", "songtext", "artist", "partitionId") SELECT "id", "songtext", "artist", "partitionId" FROM "temporary_lyrics"`, undefined);
        await queryRunner.query(`DROP TABLE "temporary_lyrics"`, undefined);
        await queryRunner.query(`ALTER TABLE "bug" RENAME TO "temporary_bug"`, undefined);
        await queryRunner.query(`CREATE TABLE "bug" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" datetime NOT NULL, "description" varchar NOT NULL, "assignorId" integer)`, undefined);
        await queryRunner.query(`INSERT INTO "bug"("id", "createdAt", "description", "assignorId") SELECT "id", "createdAt", "description", "assignorId" FROM "temporary_bug"`, undefined);
        await queryRunner.query(`DROP TABLE "temporary_bug"`, undefined);
