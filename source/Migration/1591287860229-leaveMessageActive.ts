...
export class leaveMessageActive1591287860229 implements MigrationInterface {
    name = 'leaveMessageActive1591287860229'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_partition" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "guildID" varchar NOT NULL, "suggestChannel" varchar, "leaveChannel" varchar, "leaveMessage" varchar, "leaveMessageActive" boolean)`);
        await queryRunner.query(`INSERT INTO "temporary_partition"("id", "guildID", "suggestChannel", "leaveChannel", "leaveMessage") SELECT "id", "guildID", "suggestChannel", "leaveChannel", "leaveMessage" FROM "partition"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "partition" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "guildID" varchar NOT NULL, "suggestChannel" varchar, "leaveChannel" varchar, "leaveMessage" varchar)`);
        await queryRunner.query(`INSERT INTO "partition"("id", "guildID", "suggestChannel", "leaveChannel", "leaveMessage") SELECT "id", "guildID", "suggestChannel", "leaveChannel", "leaveMessage" FROM "temporary_partition"`);
