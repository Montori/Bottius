import {
  Client, Message, MessageEmbed, TextChannel, GuildChannel,
} from 'discord.js';
...
export class SuggestCommand extends AbstractCommand {
    ...
    public async runInternal(bot: Client, message: Message, messageArray: Array<string>) {
      ...
      const suggestMessage: string = messageArray.join(' ');

      const suggestEmbed: MessageEmbed = new MessageEmbed()
      ...
      if (partition.suggestChannel) {
        const channel: TextChannel = message.guild.channels.resolve(partition.suggestChannel) as TextChannel;
